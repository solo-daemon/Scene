...
export default function CreateNewScene() {
                            ...
                            render={({ field }) => (
                                ...
                                <FormControl>
                                    ...
                                    <Input
                                        ...
                                        min={1} // Ensures no zero input
                                        onInput={(e) => {
                                        e.currentTarget.value = e.currentTarget.value.replace(/^0+/, ""); // Remove leading zeros
                                        }}
                                        onChange={(e) => {
                                        const value = e.target.value.replace(/^0+/, ""); // Remove leading zeros
                                        field.onChange(value === "" ? "" : Number(value)); // Handle empty input
                                        }}
                                        className="p-1 border-none shadow-none placeholder-[#AAAAAA] text-sm focus:outline-none focus:ring-0 ml-2"
                                    />
                                    </div>
                                </FormControl>
                                <FormMessage />
