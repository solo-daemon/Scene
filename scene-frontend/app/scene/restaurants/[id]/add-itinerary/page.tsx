...
function ItineraryForm(){
    ...
    const handleSubmit = () =>{
        ...
        if(sceneName !== ""){
            apiPost.post(`/restaurant-scenes/${id}/itinerary/`,{
                spot_name: sceneName,
                notes: notes,
                time: unixTimestamp,
            })
    ...
    return(
        <div>
            <div className="m-4">
                <div className="mt-4">
                    <div className="text-base font-bold">name of the event</div>
                ...
                <div className="mt-4">
                    <div className="text-base font-bold">any specials?</div>
                    <div>
