...
export default function AddPeoplePage(){
    ...
    const handleSendInvitation=()=>{
        apiPost.post(`/restaurant-scenes/${id}/invite/`,{
            userIds: userId,
        })
        .then((res:any)=>{
                ...
                <div className="rounded-2xl bg-[#F1F1FD] px-4 py-4">
                    <div className="flex items-center">
                        ...
                        <div className="ml-2">
                            ...
                            >can't find your friends? invite them here!</div>
                        </div>
                    </div>
            ...
            <div className="flex justify-between ">
                <div className="flex items-center">
                    <Avatar  className="rounded-xl w-[36px] h-[36px]">
                        <AvatarImage src={props.profile.gmail_pic} className="rounded-xl"/>
                        <AvatarFallback
                        >
                            <Skeleton className="h-full w-full object-cover rounded-xl relative">
                            <div className="absolute flex justify-center items-center w-full h-full">
                                <UserRound className="w-5 h-5" color="#9C9C9C" strokeWidth={1}/>
                            </div>
                            </Skeleton>
                        </AvatarFallback>
                    </Avatar>
